...
const latestAnnouncement = {
  ...
  releaseName: "ndev.t3code v1.2.3",
  version: "1.2.3",
  tag: "v1.2.3",
...
it("builds a prerelease Discord announcement for nightly subscribers", () => {
  assert.deepStrictEqual(
    buildDiscordReleaseAnnouncement({
      ...
      releaseName: "ndev.t3code Nightly 1.2.4-nightly.20260501.17 (abcdef123456)",
    ...
    {
      content:
        "<@&111111111111111111> Prerelease published: ndev.t3code Nightly 1.2.4-nightly.20260501.17 (abcdef123456)",
      allowed_mentions: {
        roles: ["111111111111111111"],
      },
      embeds: [
        {
          title: "ndev.t3code Nightly 1.2.4-nightly.20260501.17 (abcdef123456)",
          url: "https://github.com/t3dotgg/t3-code/releases/tag/v1.2.4-nightly.20260501.17",
          description: "A new ndev.t3code prerelease is available for nightly testers.",
          color: 0x5865f2,
          fields: [
            {
              name: "Version",
...
it("builds a latest Discord announcement for stable subscribers", () => {
  assert.deepStrictEqual(buildDiscordReleaseAnnouncement(latestAnnouncement), {
    content: "<@&222222222222222222> Latest published: ndev.t3code v1.2.3",
    allowed_mentions: {
      roles: ["222222222222222222"],
    },
    embeds: [
      {
        title: "ndev.t3code v1.2.3",
        url: "https://github.com/t3dotgg/t3-code/releases/tag/v1.2.3",
        description: "A new ndev.t3code latest release is available.",
        color: 0x2ecc71,
        fields: [
          {
            name: "Version",

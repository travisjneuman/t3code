  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new ndev.t3code prerelease is available for nightly testers."
          : "A new ndev.t3code latest release is available.",
...
).pipe(Command.withDescription("Post a ndev.t3code release announcement to Discord."));

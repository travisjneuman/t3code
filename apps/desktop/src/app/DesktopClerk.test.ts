...
const makeDesktopClerkLayer = (isDevelopment = true, events: string[] = []) => {
  const environment = DesktopEnvironment.DesktopEnvironment.of({
    ...
    legacyUserDataDirName: isDevelopment ? "ndev.t3code (Dev)" : "ndev.t3code (Alpha)",
...
describe("DesktopClerk", () => {
        ...
        [
          {
            ...
            passkeys: true,
            renderer: { scheme: "t3code-tjn-dev", host: "app" },
          },
        ],
      ]);
  ...
  it.each([
    { isDevelopment: true, scheme: "t3code-tjn-dev" },
    { isDevelopment: false, scheme: "t3code-tjn" },

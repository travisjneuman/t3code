...
describe("electron development launcher", () => {
  ...
  it("keeps the native Electron executable name inside the branded macOS bundle", () => {
    const paths = resolveMacLauncherPaths(
      "/repo/apps/desktop/.electron-runtime/ndev.t3code (Dev).app",
      "ndev.t3code (Dev)",
    );

    assert.equal(paths.launcherExecutableName, "ndev.t3code (Dev) Launcher");
    assert.equal(
      paths.launcherBinaryPath,
      "/repo/apps/desktop/.electron-runtime/ndev.t3code (Dev).app/Contents/MacOS/ndev.t3code (Dev) Launcher",
    );
    assert.equal(
      paths.runtimeElectronBinaryPath,
      "/repo/apps/desktop/.electron-runtime/ndev.t3code (Dev).app/Contents/MacOS/Electron",
    );
    ...
    assert.include(
      script,
      "exec '/repo/apps/desktop/.electron-runtime/ndev.t3code (Dev).app/Contents/MacOS/Electron'",
    );

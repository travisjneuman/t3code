...
ndev.t3code includes ChatGPT as a top-level desktop surface. Use the app switcher in the desktop titlebar to move between T3 Code and ChatGPT. Returning to T3 Code keeps the ChatGPT session available for the next switch.
